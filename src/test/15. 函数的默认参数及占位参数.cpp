 ...
 * @return: 
 */
int addFunc2Args(int a = 1, int b = 2)
{
    return a + b;
}
/**
 ...
 * @return: 
 */
int addFunc3Args(int a = 1, int b = 2, int c = 3) //参数全部有默认值，可以
// int addFunc3Args(int a, int b = 2, int c = 3) //第一个参数没有设置默认值，可以
// int addFunc3Args(int a = 1, int b, int c = 3) //第二个参数没有默认值，不可以
// int addFunc3Args(int a = 1, int b = 2, int c) //第三个参数没有默认值，不可以
// int addFunc3Args(int a, int b, int c = 4) //第1、2个参数没有默认值,可以
// int addFunc3Args(int a, int b = 2, int c) //第1、3个参数没有默认值,不可以
// int addFunc3Args(int a = 1, int b, int c) //第2、3个参数没有默认值,不可以
{
    return a + b + c;
}
/* 定义函数的默认参数时，声明时的默认参数和定义时的默认参数这两种方式，必须只有一个设置默认参数，避免二义性 */
int testDefine(int a = 2, int b = 3); //要么这里设置默认参数
int testDefine(int a, int b) //要么这里设置默认参数，同上语句二选一
{
    return a + b;
}
...
int getPosition(int a, int = 10) //针对调用格式为getPosition(2),见下方调用
{
    return a;
}
/**
